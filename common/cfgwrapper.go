...
func (m *CfgWrapper) GetParsingConfig(name string) (cfg ParsingConfig, err error) {
...
func (m *CfgWrapper) GetAggregateConfig(name string) (cfg AggConfig, err error) {
...
func (m *CfgWrapper) GetCommon() (combainerCfg CombainerConfig, err error) {
